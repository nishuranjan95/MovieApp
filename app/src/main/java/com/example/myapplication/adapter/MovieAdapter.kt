...
class MovieAdapter(private val movies: List<com.example.myapplication.models.Result>,val context: Context) : RecyclerView.Adapter<MovieViewHolder>() {
...
class MovieViewHolder(private val binding:SingleitemBinding) : RecyclerView.ViewHolder(binding.root) {
      fun bind(movies: List<com.example.myapplication.models.Result>,position: Int,context: Context){
